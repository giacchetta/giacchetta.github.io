...
└── pages/index.astro → HomePage.astro (Bento dashboard — 6 tiles)
    ...
    ├── Tile 2: Profile (name on top; avatar + a vertical row of 6 circular icon-only buttons below: Email → opens #contactModal, Phone → opens #phoneModal, WhatsApp/LinkedIn/GitHub/YouTube → external links)
